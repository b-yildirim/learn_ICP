...
import { idlFactory } from './learning_icp_frontend.did.js';
export { idlFactory } from './learning_icp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEARNING_ICP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./learning_icp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the learning_icp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./learning_icp_frontend.did.js")._SERVICE>}
 */
export const learning_icp_frontend = createActor(canisterId);
